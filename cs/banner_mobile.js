...
$( document ).ready( function () {
	const bannerName = 'B20WMDE_occeditors_spring_2020_1csm';
	...
	/*
	Print the banner if the current user is part of Target Group A (eligible voters):
	...
	if(showbanner != null) {
		...
		if (mw.config.get("wgUserRegistration") != null) { //only registered users
			...
			if (editCount > 200 && editCount <= 1000 && daysRegistered >= 60) {
					//User is part of Target group A
					occeditorsBanner.init();
				}
		}
	}
