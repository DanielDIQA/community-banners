...
const BANNER_ILLUSTRATION_URL = '//upload.wikimedia.org/wikipedia/commons/2/26/Cake-actionweek1.png'; //Kuchen
const BANNER_TITLE_COLOR = '#014acf'; // blue for ctrl
const BANNER_BACKGROUND_COLOR = '#efbc00'; // yellow
